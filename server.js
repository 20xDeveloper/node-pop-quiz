...
const url = 'mongodb+srv://Lami:c@cluster0-e494i.mongodb.net/node-pop-quiz?retryWrites=true'; //the url to connect to the Mongodb. (see code below)
...
app.use(express.static('public'));
    ...
    //I GUESS THE ORDER DOESNT MATTER BECAUSE I USED DB ABOVE THIS BLOCK OF CODE
...
//btw i dont need the bottom block of code because I manually connected to a port using nodeChef. They do it
//for you automatically. Common sense if you really think about it
